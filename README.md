...
See the [full API reference](docs/api-reference.md) for all endpoints, query parameters, note body types, colour values, and usage examples. Interactive docs are also available at `/openapi` (Swagger UI) when running the app.
