...
export default function Header({
  ...
  return (
    <header className="fixed top-0 left-0 right-0 h-16 bg-white dark:bg-[#202124] border-b border-gray-100 dark:border-[#3c4043] flex items-center gap-2 sm:gap-4 px-2 sm:px-4 z-50">
      <button
