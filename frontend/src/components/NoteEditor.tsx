...
const BG_COLORS: Record<string, string> = {
  ...
  RED: "bg-keep-red dark:bg-[#3c2222]",
  ORANGE: "bg-keep-orange dark:bg-[#3c2a1a]",
  YELLOW: "bg-keep-yellow dark:bg-[#3c3820]",
  GREEN: "bg-keep-green dark:bg-[#1e3520]",
  TEAL: "bg-keep-teal dark:bg-[#1a3030]",
  BLUE: "bg-keep-blue dark:bg-[#1a2a3a]",
  CERULEAN: "bg-keep-cerulean dark:bg-[#1a2838]",
  PURPLE: "bg-keep-purple dark:bg-[#2a1a3a]",
  PINK: "bg-keep-pink dark:bg-[#3a202a]",
  BROWN: "bg-keep-brown dark:bg-[#2a221a]",
  GRAY: "bg-keep-gray dark:bg-[#2a2a2a]",
