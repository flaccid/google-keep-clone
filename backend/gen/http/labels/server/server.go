...
// New instantiates HTTP handlers for all the labels service endpoints using
...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			{"List", "GET", "/v1/labels"},
			{"Create", "POST", "/v1/labels"},
			{"Update", "PATCH", "/v1/labels/{id}"},
			{"Delete", "DELETE", "/v1/labels/{id}"},
		},
...
func (s *Server) Service() string { return "labels" }
...
func (s *Server) MethodNames() []string { return labels.MethodNames[:] }
...
// MountListHandler configures the mux to serve the "labels" service "list"
// endpoint.
func MountListHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/v1/labels", f)
}

// NewListHandler creates a HTTP handler which loads the HTTP request and calls
// the "labels" service "list" endpoint.
func NewListHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		ctx = context.WithValue(ctx, goa.ServiceKey, "labels")
		var err error
...
// MountCreateHandler configures the mux to serve the "labels" service "create"
// endpoint.
...
// MountUpdateHandler configures the mux to serve the "labels" service "update"
// endpoint.
...
// MountDeleteHandler configures the mux to serve the "labels" service "delete"
// endpoint.
func MountDeleteHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("DELETE", "/v1/labels/{id}", f)
}

// NewDeleteHandler creates a HTTP handler which loads the HTTP request and
// calls the "labels" service "delete" endpoint.
